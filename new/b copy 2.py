...
np.save(f"data/b_s{n_seed}_wn{alpha_wn0}_{alpha_wn1}_T{T}_step{step}_t{end}_param_all.npy",param_all)
#np.save(f"k_s{n_seed}_m{alpha_lambda}_T{T}_t{end}_param_all_old.npy",param_all_old)
np.savetxt(f"data/b_s{n_seed}_wn{alpha_wn0}_{alpha_wn1}_T{T}_step{step}_t{end}_e_all.csv",e_all)