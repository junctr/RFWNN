...
np.save(f"k_s{n_seed}_m{alpha_lambda}_T{T}_t{end}_az{alpha_zeta}_param_all.npy",param_all)
#np.save(f"k_s{n_seed}_m{alpha_lambda}_T{T}_t{end}_param_all_old.npy",param_all_old)
np.savetxt(f"k_s{n_seed}_m{alpha_lambda}_T{T}_t{end}_az{alpha_zeta}_e_all.csv",e_all)